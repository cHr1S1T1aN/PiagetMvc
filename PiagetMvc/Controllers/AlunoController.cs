...
namespace PiagetMvc.Controllers
{
    public class AlunoController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Nome,Email,Telefone,Id")] Aluno aluno)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("Nome,Email,Telefone,Id")] Aluno aluno)
        {
            if (id != aluno.Id)
            {
                return NotFound();
